    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <span style={{ fontSize: 27, fontWeight: 700, letterSpacing: "-0.06em" }}>
        ...
        >
          <span>Product thinking · Software engineering · Cloud infrastructure</span>
          <span style={{ color: "#f4f2ec", fontWeight: 600 }}>rmkasendwa.com ↗</span>
        </div>
      </div>
    ),
    size,
